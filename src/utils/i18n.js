const translations = {
    en: {
        ...
        smartMode: 'Enable Smart Mode',
        smartModeDesc: 'Prioritizes questions you got wrong in past sessions (60% weak questions + 40% random). Requires random order.',
    ...
    it: {
        ...
        smartMode: 'Abilita Modalità Smart',
        smartModeDesc: 'Dà priorità alle domande sbagliate nelle sessioni passate (60% domande deboli + 40% random). Richiede ordine casuale.',
